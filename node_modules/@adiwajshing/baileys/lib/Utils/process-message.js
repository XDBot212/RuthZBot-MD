...
const processMessage = async (message, { downloadHistory, ev, historyCache, recvChats, creds, keyStore, logger, options }) => {
    var _a, _b, _c, _d;
        ...
        switch (protocolMsg.type) {
            case WAProto_1.proto.Message.ProtocolMessage.Type.HISTORY_SYNC_NOTIFICATION:
                ...
                if (downloadHistory) {
                    ...
                    const { chats, contacts, messages, didProcess } = await (0, Utils_1.downloadAndProcessHistorySyncNotification)(histNotification, historyCache, recvChats, options);
                    if (chats.length) {
